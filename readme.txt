...
3. When the popup appears, select the push-notifications-for-web.1.0.zip file from your desktop.
...
1. Notification Setup Option.
2. Send Manual Push Notification.
3. Post and Page Push Notification Option.
